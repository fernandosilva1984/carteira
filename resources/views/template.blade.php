...
<div id="voyager-loader">
    <?php $admin_loader_img = Voyager::setting('site.loader', ''); ?>
    @if($admin_loader_img == '')
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('voyager.dashboard') }}">
                    <div class="logo-icon-container">
                        <?php $admin_logo_img = Voyager::setting('site.icon_image', ''); ?>
                        @if($admin_logo_img == '')
                            <img src="{{ voyager_asset('images/logo-icon-light.png') }}" alt="Logo Icon">
                        @else
                            <img src="{{ Voyager::image($site_logo_img) }}" alt="Logo Icon">
                        @endif
                    </div>
                    <div class="title">{{Voyager::setting('site.title', 'VOYAGER')}}</div>
                </a>
            </div><!-- .navbar-header -->
